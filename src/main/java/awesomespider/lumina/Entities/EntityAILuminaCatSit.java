 ...
 */
public class EntityAILuminaCatSit extends EntityAIBase
{
    private final EntityLuminaCat field_151493_a;
    ...
    public EntityAILuminaCatSit(EntityLuminaCat p_i45315_1_, double p_i45315_2_)
    {
